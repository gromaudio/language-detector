...
import static com.optimaize.langdetect.guava.base.Preconditions.checkArgument;
import static com.optimaize.langdetect.guava.base.Preconditions.checkNotNull;

import com.optimaize.langdetect.guava.annotations.GwtCompatible;
import java.io.Serializable;
import java.util.Map;
import javax.annotation.Nullable;

/**
 * Static utility methods pertaining to {@code com.optimaize.langdetect.guava.base.Function} instances; see that
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link com.optimaize.langdetect.guava.collect.BiMap BiMap} (or can be one), you
   * can use {@link com.optimaize.langdetect.guava.collect.Maps#asConverter Maps.asConverter} instead to get a
