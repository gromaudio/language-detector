 ...
 * example round-trip using {@link com.optimaize.langdetect.guava.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     com.optimaize.langdetect.guava.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     com.optimaize.langdetect.guava.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
